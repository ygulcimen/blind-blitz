-- ============================================
-- 🚀 ONE-STEP FIX FOR EVERYTHING
-- Copy and paste this entire file into Supabase SQL Editor
-- ============================================

-- This file will:
-- ✅ Fix guest cleanup function (was broken due to missing 'updated_at' column)
-- ✅ Add bot game cleanup (frees stuck bots)
-- ✅ Set up automatic cron jobs (daily + hourly)
-- ✅ Create preview functions for safe testing
...
-- ============================================
-- STEP 3: Create bot game cleanup (NEW!)
-- ============================================
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🎮 Guest cleanup: FIXED (now uses created_at)';
